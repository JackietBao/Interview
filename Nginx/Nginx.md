...
![image-20240317151840496](assets/Nginx/image-20240317151840496.png)
...
![image-20240317151900651](assets/Nginx/image-20240317151900651.png)
...
![image-20240317152007793](assets/Nginx/image-20240317152007793.png)
...
![image-20240317152020297](assets/Nginx/image-20240317152020297.png)
...
![image-20240317152100558](assets/Nginx/image-20240317152100558.png)
...
![image-20240317152120614](assets/Nginx/image-20240317152120614.png)
...
![image-20240317152140574](assets/Nginx/image-20240317152140574.png)
...
![image-20240317152539907](assets/Nginx/image-20240317152539907.png)
...
![image-20240317152555266](assets/Nginx/image-20240317152555266.png)

1、客户端翻墙

比如：科学的方式访问Google

![image-20240317152626200](assets/Nginx/image-20240317152626200.png)

2、客户端提速

比如：游戏加速器

![image-20240317152645829](assets/Nginx/image-20240317152645829.png)

3、客户端缓存

比如:下载资源，可以先查看代理服务是否有，如果有直接通过代理获取

![image-20240317152655131](assets/Nginx/image-20240317152655131.png)

4、客户端授权

很多公司为了安全，连接外网需要通过防火墙，防火墙可以配置规则，允许谁可以上外网，谁不可以上外网。

![image-20240317152739652](assets/Nginx/image-20240317152739652.png)

#### 反向代理

反向代理，用于公司集群架构中，客户端->代理<-->服务端

![image-20240317152748583](assets/Nginx/image-20240317152748583.png)

1、路由功能

根据用户请求的URI调度到不同的功能的服务器进行处理

![image-20240317152800277](assets/Nginx/image-20240317152800277.png)

2、负载均衡

将用户发送的请求，通过负载均衡调度算法挑选一台合适的节点进行请求处理。

![image-20240317152810246](assets/Nginx/image-20240317152810246.png)

3、动静分离

根据用户请求的URI进行区分，将动态资源调度至应用服务器处理，将静态资源调度至静态资源服务器处理。

![image-20240317152819152](assets/Nginx/image-20240317152819152.png)

4、数据缓存

将后端查询的数据存储至反向代理上缓存，可以加速用户获取资源。

![image-20240317152827233](assets/Nginx/image-20240317152827233.png)
...
![image-20240317152853850](assets/Nginx/image-20240317152853850.png)

通常情况下，我们将Nginx作为反向代理，常常会用到如下几种代理协议

![image-20240317152913713](assets/Nginx/image-20240317152913713.png)
...
![image-20240317152948985](assets/Nginx/image-20240317152948985.png)
...
![image-20240317153004576](assets/Nginx/image-20240317153004576.png)

2、七层负载均衡

七层负载均衡工作在应用层，它可以完成很多应用方面的协议请求，比如我们说的 http 应用负载均衡，它可以实现 http 头信息的改写、安全应用规则控制、 URI 匹配规则控制、及rewrite 等功能，所以在应用层里面可以做的内容就更多了

![image-20240317153019619](assets/Nginx/image-20240317153019619.png)
...
![image-20240317153104377](assets/Nginx/image-20240317153104377.png)
...
![image-20240317153136848](assets/Nginx/image-20240317153136848.png)
...
![image-20240317153152872](assets/Nginx/image-20240317153152872.png)
